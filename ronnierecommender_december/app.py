...
# Force Streamlit Cloud to use pysqlite3
try:
    import pysqlite3
    sys.modules["sqlite3"] = pysqlite3
except ImportError:
    print("pysqlite3 not found. Falling back to default sqlite3.")

import sqlite3
print(f"SQLite version in use: {sqlite3.sqlite_version}")
...
def main():
    # para sa page configuration for title and favicon (page logo)
    st.set_page_config(
...
# Centering the image using markdown and custom CSS
    ...
    # temporary tanggal sa delete_chat_col.button("Delete Chat Session", on_click=delete_chat_session_history)
